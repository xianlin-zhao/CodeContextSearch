...
OUTPUT_GRAPH_PATH = "/data/data_public/riverbag/testRepoSummaryOut/211/mingus/graph_results_***all"
PROJECT_PATH = "/data/lowcode_public/DevEval/Source_Code/Multimedia"
...
def process_graph_dir(
    ...
    for i, task in enumerate(tasks):
        ...
        if node_codes:
            code_embs = embedder.encode_code(node_codes, batch_size=16)
